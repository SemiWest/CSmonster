...
PLAYER_SKILLS = {
    ...
    "PS": [
        ...
        {"name": "PNP",  
         ...
         "skW": 75,  
         "type": "PS",  
         "description": "PNP문제를 해결했다. 전 세계 수학자들은 당신의 편이다. 공격력이 3랭크 오른다.",  
         "level": 3,  
         "priority": 0,  
         "animation": "none",  
         "bonus_effect": ["buff", 6]},
    ...
    "SYS": [
        {"name": "스택오버플로우",  
         ...
         "skW": 45,  
         "type": "SYS",  
         "description": "상대의 머리를 과부화시키고 준 데미지의 1/4를 회복한다.",  
         "level": 1,  
         "priority": 0,  
         "animation": "none",  
        ...
        {"name": "CTRL^C",  
         ...
         "skW": 50,  
         "type": "SYS",  
         "description": "상대 쉘을 다운시키고 준 데미지의 절반을 회복한다.",  
         "level": 2,  
         "priority": 0,  
         "animation": "none",  
        ...
        {"name": "DDOS",  
         ...
         "skW": 60,  
         "type": "SYS",  
         "description": "상대에게 무한한 공격 요청을 보내 다운시키고 준 데미지의 절반을 회복한다.",  
         "level": 3,  
         "priority": 1,  
         "animation": "none",  
         "bonus_effect": ["heal", "absorb", 0.5]},
        {"name": "핀토스",  
         ...
         "skW": 75,  
         "type": "SYS",  
         "description": "핀토스를 끝낸 자. 어떤 과제가 와도 이겨낼 수 있다.",  
         "level": 1,  
         "priority": 2,  
         "animation": "none",  
    ...
    "DS": [
        {"name": "OOP",  
         ...
         "skW": 45,  
         "type": "DS",  
         "description": "상대를 객체화시킨다. 상대 메서드의 취약점을 파악해보자",  
         "level": 1,  
         "priority": 0,  
         "animation": "none",  
         "bonus_effect": ["buff", 1]},
        {"name": "SQL 인젝션",  
         ...
         "skW": 70,  
         "type": "DS",  
         "description": "상대에게 SQL 인젝션 공격을 가한다",  
         "level": 2,  
         "priority": 0,  
         "animation": "none",  
         "bonus_effect": ["buff", 4]}
    ...
    "AI": [
        {"name": "오버피팅",  
         ...
         "skW": 70,  
         "type": "AI",  
         "description": "상대를 과적합 학습 완벽하게 공격한다",  
         "level": 1,  
         "priority": 2,  
         "animation": "none"},
        {"name": "샘 올트먼",  
