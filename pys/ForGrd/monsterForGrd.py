...
# CT: 격투 (체급이 높음) / DS: 불꽃 (무상성) / PS: 노말 / SN: 강철 (방어) / AI: 드래곤
TYPE_EFFECTIVENESS = {
    "CT": {"CT": 1.0, "DS": 1.0, "PS": 2.0, "SN": 1.0, "AI": 0.5},
    "DS": {"CT": 1.0, "DS": 1.0, "PS": 1.0, "SN": 1.0, "AI": 1.0},
    "PS": {"CT": 1.0, "DS": 1.0, "PS": 2.0, "SN": 0.5, "AI": 1.0},
    "SN": {"CT": 1.0, "DS": 1.0, "PS": 1.0, "SN": 0.5, "AI": 1.0},
    "AI": {"CT": 2.0, "DS": 1.0, "PS": 1.0, "SN": 0.5, "AI": 2.0},
}
